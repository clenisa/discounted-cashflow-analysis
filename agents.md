...
- **Visuals**: `VisualizationPanel` renders a Value Bridge waterfall chart plus a `PieChart` splitting projections vs terminal PV.
...
- **Chart & Table Verification**
  ...
  - Hover Value Bridge bars to confirm tooltip currency formatting and that the steps reconcile to the enterprise value.
